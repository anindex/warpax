...
- Type-IV fraction: full=3.50%, wall=100.00%
- Type I/II/III/IV wall breakdown: 0.00% / 0.00% / 0.00% / 100.00%
- Full-grid miss % (Eulerian satisfied, robust violated): NEC=0.00%, WEC=0.00%, SEC=3.82%, DEC=0.00%
...
- Full-grid miss % (Eulerian satisfied, robust violated): NEC=0.02%, WEC=0.06%, SEC=0.05%, DEC=0.01%
- Wall-restricted conditional miss rate: NEC=10.38%, WEC=22.32%, SEC=20.39%, DEC=0.00%
- Elapsed: 7.8s
...
|--------|-------------|--------------|--------------|------------------|----------------|--------|
| alcubierre | 416 | 3.50% | 100.00% | 0.00% | 0.00% |  |
