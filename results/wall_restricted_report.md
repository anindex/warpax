...
- Total grid points: 125000
- Type-IV fraction: full=0.00%, wall=0.00%
- Type I/II/III/IV wall breakdown: 58.93% / 27.98% / 13.10% / 0.00%
- Full-grid miss % (Eulerian satisfied, robust violated): NEC=0.01%, WEC=0.02%, SEC=0.02%, DEC=0.01%
- Wall-restricted conditional miss rate: NEC=0.00%, WEC=11.54%, SEC=9.38%, DEC=0.00%
- Elapsed: 11.0s
